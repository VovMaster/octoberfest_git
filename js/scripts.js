...
$(function() { 
    ...
    var audio = a[i];
        first = $(this).closest('.audio-wrap').find('ol a').attr('data-src');
    $(this).closest('.audio-wrap').find('ol li').first().addClass('playing');
    audio.load(first);

    // Load in a track on click
    $(this).closest('.audio-wrap').find('ol li').click(function(e) {
      e.preventDefault();
    ...
    $(this).closest('.audio-wrap').find('.prev-audio').click(function(e) {
    	$('.prev-audio')
    });
